...
User1 = User(name="Kristina", email="kulchihinakristi@gmail.com",
             picture="""http://xn----8sbiecm6bhdx8i.xn--p1ai/sites/default/
             files/images/uchitelu/risunok_tort.jpg""")
session.add(User1)
session.commit()


# Cake Zaher
cake1 = Cake(name="Zaher",
             description="Cholocate biscuit with kompate dried apricots",
             course="Cholocate")
